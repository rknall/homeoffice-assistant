# AGENTS.md - Project Guidelines for Agents Code
...
**IMPORTANT:** This project uses Anthropic Skills for design and document guidance. Before implementing UI components or document generation, consult the relevant skill:
...
```bash
# Development - Backend
cd /Users/rknall/Development/Projects/HomeOfficeAssistant
