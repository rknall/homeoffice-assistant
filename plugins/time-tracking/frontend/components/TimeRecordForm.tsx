...
export function TimeRecordForm({
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-4">
      ...
      {/* Day type selection */}
      <div>
        <label htmlFor="day-type" className="block text-sm font-medium text-gray-700 mb-1">
          Day Type
        </label>
        <select
          id="day-type"
      ...
      {isWorkType && (
        <>
          ...
          <div>
            <label htmlFor="break-minutes" className="block text-sm font-medium text-gray-700 mb-1">
              Break (minutes)
            </label>
            <input
              type="number"
