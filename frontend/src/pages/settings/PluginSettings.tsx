...
export function PluginSettings() {
  ...
  useEffect(() => {
    setBreadcrumb([{ label: 'Settings', href: '/settings' }, { label: 'Plugins' }])
  }, [setBreadcrumb])
          ...
          {isLoading ? (
            ...
            <div className="text-center py-8">
              ...
              <p className="text-gray-500">
                No plugins installed. Install a plugin to extend the application functionality.
              </p>
            </div>
          ) : (
                  ...
                  <div className="flex items-center justify-between">
                    <div className="flex-1">
                      ...
                      <div className="flex items-center gap-4 mt-2 text-xs text-gray-400">
                        ...
                        {plugin.manifest?.author && <span>Author: {plugin.manifest.author}</span>}
                      </div>
                    </div>
      ...
      >
        <div className="space-y-4">
          <p className="text-sm text-gray-600">
            Upload a plugin package (ZIP file) to install a new plugin or to upgrade an existing
            one.
          </p>
        ...
        {isLoadingInfo ? (
          ...
          <div className="space-y-6">
              ...
              <dl className="grid grid-cols-2 gap-4 text-sm">
                ...
                {pluginInfo.migration_version && (
                  <div>
                    ...
                    <dd className="font-mono text-xs">{pluginInfo.migration_version}</dd>
                  </div>
                )}
              </dl>
            </div>
            ...
            {Object.keys(pluginInfo.config_schema || {}).length > 0 && (
              <div>
                <h3 className="font-medium text-gray-900 mb-2">Configuration Schema</h3>
          ...
          <p className="text-gray-500">No configuration available for this plugin.</p>
        )}
      </Modal>
      ...
      >
        <div className="space-y-4">
          <p className="text-gray-600">
            ...
            <strong>{selectedPlugin?.manifest?.name || selectedPlugin?.plugin_id}</strong>?
          </p>
